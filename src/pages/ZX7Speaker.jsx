...
import two from "../assets/music.svg";
import place from "../assets/table.svg";
import speakZx7 from "../assets/Zx7S.svg";
import speakr from "../assets/spea.svg";
      ...
      <div>
        ...
        <div className="img-side flex ml-[220px] mt-[399px]">
          <div className="one-side flex flex-col gap-8">
            <img src={speakr} className="" alt="" />
            <img className="" src={two} alt="" />
          </div>
          <div className="secound-side ">
            <img src={place} className="pl-8 " alt="" />
          </div>
        </div>
            ...
            <div>
              <div className="w-[350px] mt-[64px] h-[318px] bg-[#F1F1F1] rounded-xl">
                <img
                  src={white}
                  alt=""
                  className="translate-x-20 translate-y-16 w-[178px] h-[193px]"
                />
              </div>
              <h1 className="uppercase pl-[140px] pt-10 text-[24px] leading-[32.78px] tracking-[1.71px]">
                XX59
              </h1>
              <Link to={"/XX59"}>
                <button className="text-white  ml-[113px] hover:bg-[#FBAF85] mt-[32px] btn bg-[#D87D4A]  uppercase">
