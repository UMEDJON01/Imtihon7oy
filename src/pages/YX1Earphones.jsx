...
import huba from "../assets/huba.svg";
import { Link } from "react-router-dom";
import { useEffect, useState } from "react";
import speak from "../assets/speaker.svg";
import white from "../assets/white.svg";
import two from "../assets/new.svg";
import place from "../assets/Both.svg";
        ...
        <div className="w-[1110px] ml-[220px] h-[571px] mt-[160px]">
          ...
          <div className="w-[1110px] h-[471px] flex gap-8 mt-8 items-center justify-center">
            ...
            <div>
              ...
              <h1 className="pl-[140px] pt-10 text-[24px] leading-[32.78px] tracking-[1.71px]">
                XX59
              </h1>
              <Link to={"/XX59"}>
                <button className="text-white  ml-[113px] hover:bg-[#FBAF85] mt-[32px] btn bg-[#D87D4A]  uppercase">
